...
module.exports = {
  ...
  name: 'El nombre debe tener 3 caracteres minimo',
  email: 'Correo no valido',
  username: 'Debe tener entre 4 y 32 caracteres de longitud',
  pass: 'Debe tener al menos 6 caracteres, y contener al menos un numero',
  strongpass: 'Debe tener al menos 6 caracteres, y contener al menos un numero',
  phone: 'Debe ser un numero de telefono',
  zip: 'Debe ser un codigo valido',
  url: 'Debe ser una URL valida',
  number: 'Debe ser un numero',
  range: 'Debe ser un numero entre {0} y {1}',
  min: 'Debe tener al menos {0} caracteres de longitud',
  max: 'Debe tener menos de {0} caracteres',
  minoption: 'Selecciona al menos {0} opcion',
  maxoption: 'Selecciona no mas {0} opcion',
  minmax: 'Debe tener entre {0} y {1} caracteres de longitud',
  select: 'Selecciona una opcion',
  extension: 'Extension no valida ({*})',
  equalto: 'Debe ser el mismo valor del campo "{0}"',
  ...
  options: {
    ...
    steps: {
      ...
      buildNavItems: function(i) {
        return this.opts.steps.i18n.step;
      },
      wrap: '.idealsteps-wrap',
      step: '.idealsteps-step',
      activeClass: 'idealsteps-step-active',
      ...
      i18n: {
        step: 'Registro de Usuario&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp' +
